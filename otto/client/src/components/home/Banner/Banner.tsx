...
<section className="mx-auto max-w-7xl px-6 py-16 text-center">
  ...
  <p className="md:text-3xl text-gray-700 max-w-3xl mx-auto">
    Tecnologia para quem protege o futuro.
    Potencialize suas ações ambientais com aplicativos
    especializados em gestão, monitoramento e sustentabilidade.
...
<div className="flex flex-col md:flex-row items-center max-w-6xl w-full bg-white shadow-lg rounded-xl overflow-hidden h-[450px] mb-12">
  ...
  />
  <div className="p-6 md:w-1/2 h-full flex flex-col justify-center text-left">
...
<div className="flex flex-col md:flex-row-reverse items-center max-w-6xl w-full bg-white shadow-lg rounded-xl overflow-hidden h-[450px] mb-12">
  ...
  <div className="p-6 md:w-1/2 h-full flex flex-col justify-center text-center md:text-left">
    <h2 className="text-3xl font-bold mb-4 text-green-700">Ia.bixo</h2>
    <p className="text-gray-700 text-lg mb-6">
    Nosso apliicativo que usa IA avançada para identificar e destacar animais automaticamente.
    </p>
    {/* Botões verticais */}
    <div className="flex flex-col gap-4 items-center md:items-start">
      ...
      <div
  className="w-screen h-[600px] bg-cover bg-center bg-no-repeat flex items-center justify-center text-white mb-0 overflow-hidden"
  style={{
    backgroundImage: "url('/2.png')",
  }}
>
  <div className="bg-black/20 p-8 rounded-lg text-center max-w-3xl">
